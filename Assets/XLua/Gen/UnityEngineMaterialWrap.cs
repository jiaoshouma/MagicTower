		    ...
		    try {
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Color>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        DG.Tweening.Core.TweenerCore<UnityEngine.Color, UnityEngine.Color, DG.Tweening.Plugins.Options.ColorOptions> gen_ret = gen_to_be_invoked.DOColor( _endValue, _propertyID, _duration );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Color>(L, 2)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        DG.Tweening.Core.TweenerCore<UnityEngine.Color, UnityEngine.Color, DG.Tweening.Plugins.Options.ColorOptions> gen_ret = gen_to_be_invoked.DOColor( _endValue, _property, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        DG.Tweening.Core.TweenerCore<UnityEngine.Color, UnityEngine.Color, DG.Tweening.Plugins.Options.ColorOptions> gen_ret = gen_to_be_invoked.DOFade( _endValue, _propertyID, _duration );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        DG.Tweening.Core.TweenerCore<UnityEngine.Color, UnityEngine.Color, DG.Tweening.Plugins.Options.ColorOptions> gen_ret = gen_to_be_invoked.DOFade( _endValue, _property, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.FloatOptions> gen_ret = gen_to_be_invoked.DOFloat( _endValue, _propertyID, _duration );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.FloatOptions> gen_ret = gen_to_be_invoked.DOFloat( _endValue, _property, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Vector2>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        DG.Tweening.Core.TweenerCore<UnityEngine.Vector2, UnityEngine.Vector2, DG.Tweening.Plugins.Options.VectorOptions> gen_ret = gen_to_be_invoked.DOOffset( _endValue, _duration );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector2>(L, 2)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        DG.Tweening.Core.TweenerCore<UnityEngine.Vector2, UnityEngine.Vector2, DG.Tweening.Plugins.Options.VectorOptions> gen_ret = gen_to_be_invoked.DOOffset( _endValue, _property, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Vector2>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        DG.Tweening.Core.TweenerCore<UnityEngine.Vector2, UnityEngine.Vector2, DG.Tweening.Plugins.Options.VectorOptions> gen_ret = gen_to_be_invoked.DOTiling( _endValue, _duration );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector2>(L, 2)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        DG.Tweening.Core.TweenerCore<UnityEngine.Vector2, UnityEngine.Vector2, DG.Tweening.Plugins.Options.VectorOptions> gen_ret = gen_to_be_invoked.DOTiling( _endValue, _property, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector4>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        DG.Tweening.Core.TweenerCore<UnityEngine.Vector4, UnityEngine.Vector4, DG.Tweening.Plugins.Options.VectorOptions> gen_ret = gen_to_be_invoked.DOVector( _endValue, _propertyID, _duration );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector4>(L, 2)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        DG.Tweening.Core.TweenerCore<UnityEngine.Vector4, UnityEngine.Vector4, DG.Tweening.Plugins.Options.VectorOptions> gen_ret = gen_to_be_invoked.DOVector( _endValue, _property, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Color>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        DG.Tweening.Tweener gen_ret = gen_to_be_invoked.DOBlendableColor( _endValue, _propertyID, _duration );
                        translator.Push(L, gen_ret);
