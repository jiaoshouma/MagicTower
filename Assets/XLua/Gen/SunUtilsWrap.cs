...
namespace XLua.CSObjectWrap
{
    ...
    public class SunUtilsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(SunUtils);
        ...
        {
            return LuaAPI.luaL_error(L, "SunUtils does not have a constructor!");
        }
        ...
        static int _m_AddChild_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.GameObject>(L, 1)&& translator.Assignable<UnityEngine.GameObject>(L, 2)) 
                {
                    ...
                    UnityEngine.GameObject _res = (UnityEngine.GameObject)translator.GetObject(L, 2, typeof(UnityEngine.GameObject));
                    
                        UnityEngine.GameObject gen_ret = SunUtils.AddChild( _parent, _res );
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.GameObject>(L, 1)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    string _childName = LuaAPI.lua_tostring(L, 2);
                        ...
                        UnityEngine.GameObject gen_ret = SunUtils.AddChild( _parent, _childName );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to SunUtils.AddChild!");
