...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(KEngine.LoaderMode), KEngineLoaderModeWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(UnityEngine.Profiling.Profiler), UnityEngineProfilingProfilerWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(SunUtils), SunUtilsWrap.__Register);
...
namespace XLua
{
	...
	internal partial class InternalGlobals
    {
		...
		delegate void __GEN_DELEGATE203( UnityEngine.RectTransform rectTrans,  float width);
		
		delegate void __GEN_DELEGATE204( UnityEngine.RectTransform rectTrans,  float height);
		
		delegate void __GEN_DELEGATE205( UnityEngine.Transform t,  float newX);
		
		delegate void __GEN_DELEGATE206( UnityEngine.Transform t,  float newY);
		
		delegate void __GEN_DELEGATE207( UnityEngine.Transform t,  float newX);
		
		delegate void __GEN_DELEGATE208( UnityEngine.Transform t,  float newY);
		
		delegate void __GEN_DELEGATE209( UnityEngine.Transform t,  float newZ);
		
		delegate void __GEN_DELEGATE210( UnityEngine.Transform t,  float newZ);
		
		delegate void __GEN_DELEGATE211( UnityEngine.Transform t,  UnityEngine.Vector3 newScale);
		
		delegate void __GEN_DELEGATE212( UnityEngine.Transform t);
		
		delegate float __GEN_DELEGATE213( UnityEngine.Transform t);
		
		delegate float __GEN_DELEGATE214( UnityEngine.Transform t);
		
		delegate float __GEN_DELEGATE215( UnityEngine.Transform t);
		
		delegate float __GEN_DELEGATE216( UnityEngine.Transform t);
		
		delegate float __GEN_DELEGATE217( UnityEngine.Transform t);
		
		delegate float __GEN_DELEGATE218( UnityEngine.Transform t);
		
		delegate bool __GEN_DELEGATE219( UnityEngine.GameObject gobj);
		
		delegate bool __GEN_DELEGATE220( UnityEngine.GameObject gobj);
		
		delegate void __GEN_DELEGATE221( UnityEngine.Animation anim,  float newSpeed);
		
		delegate UnityEngine.Vector2 __GEN_DELEGATE222( UnityEngine.Vector3 vec);
		
		delegate byte __GEN_DELEGATE223( string val);
		
		delegate long __GEN_DELEGATE224( string val);
		
		delegate float __GEN_DELEGATE225( string val);
		
		delegate int __GEN_DELEGATE226( string str);
		
		delegate int __GEN_DELEGATE227( object obj);
	    ...
	    static InternalGlobals()
		{
		    extensionMethodMap = new Dictionary<Type, IEnumerable<MethodInfo>>()
			{
				...
				{typeof(UnityEngine.Transform), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE205(KEngineExtensions.SetPositionX)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE206(KEngineExtensions.SetPositionY)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE207(KEngineExtensions.SetLocalPositionX)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE208(KEngineExtensions.SetLocalPositionY)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE209(KEngineExtensions.SetPositionZ)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE210(KEngineExtensions.SetLocalPositionZ)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE211(KEngineExtensions.SetLocalScale)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE212(KEngineExtensions.SetLocalScaleZero)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE213(KEngineExtensions.GetPositionX)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE214(KEngineExtensions.GetPositionY)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE215(KEngineExtensions.GetPositionZ)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE216(KEngineExtensions.GetLocalPositionX)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE217(KEngineExtensions.GetLocalPositionY)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE218(KEngineExtensions.GetLocalPositionZ)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(UnityEngine.RectTransform), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE203(KEngineExtensions.SetWidth)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE204(KEngineExtensions.SetHeight)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(UnityEngine.GameObject), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE219(KEngineExtensions.HasRigidbody)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE220(KEngineExtensions.HasAnimation)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(UnityEngine.Animation), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE221(KEngineExtensions.SetSpeed)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(UnityEngine.Vector3), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE222(KEngineExtensions.ToVector2)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(string), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE223(KEngineExtensions.ToByte)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE224(KEngineExtensions.ToInt64)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE225(KEngineExtensions.ToFloat)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE226(KEngineExtensions.ToInt32)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(object), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE227(KEngineExtensions.ToInt32)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
