...
namespace XLua
{
	...
	internal partial class InternalGlobals
    {
		...
		delegate long __GEN_DELEGATE21( string val);
		
		delegate float __GEN_DELEGATE22( string val);
		
		delegate int __GEN_DELEGATE23( string str);
		
		delegate int __GEN_DELEGATE24( object obj);
	    ...
	    static InternalGlobals()
		{
		    extensionMethodMap = new Dictionary<Type, IEnumerable<MethodInfo>>()
			{
				...
				{typeof(UnityEngine.RectTransform), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE0(KEngineExtensions.SetWidth)
				  ...
				  new __GEN_DELEGATE1(KEngineExtensions.SetHeight)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(UnityEngine.Transform), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE2(KEngineExtensions.SetPositionX)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE3(KEngineExtensions.SetPositionY)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE4(KEngineExtensions.SetLocalPositionX)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE5(KEngineExtensions.SetLocalPositionY)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE6(KEngineExtensions.SetPositionZ)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE7(KEngineExtensions.SetLocalPositionZ)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE8(KEngineExtensions.SetLocalScale)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE9(KEngineExtensions.SetLocalScaleZero)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE10(KEngineExtensions.GetPositionX)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE11(KEngineExtensions.GetPositionY)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE12(KEngineExtensions.GetPositionZ)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE13(KEngineExtensions.GetLocalPositionX)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE14(KEngineExtensions.GetLocalPositionY)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE15(KEngineExtensions.GetLocalPositionZ)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(UnityEngine.GameObject), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE16(KEngineExtensions.HasRigidbody)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE17(KEngineExtensions.HasAnimation)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(UnityEngine.Animation), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE18(KEngineExtensions.SetSpeed)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(UnityEngine.Vector3), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE19(KEngineExtensions.ToVector2)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(string), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE20(KEngineExtensions.ToByte)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE21(KEngineExtensions.ToInt64)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE22(KEngineExtensions.ToFloat)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE23(KEngineExtensions.ToInt32)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(object), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE24(KEngineExtensions.ToInt32)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
